<?php
	...
	$tpl->load_file('location_wise_inventory_view.html','main_container');
	...
	/* Set heading */
	$tpl->set_var("mainheading","Inventory View");
	
	$locid = "";
	if(isset($_REQUEST["loc"]) && trim($_REQUEST["loc"]) != '')
		$locid = trim($_REQUEST["loc"]);
	
	$tpl->set_var("locid",$locid);
	
	/* Set breadcrumb */
	$breadcrumb = '<li><a href="location_wise_inventory_report.php">Location Wise Inventory Report</a></li><span class="divider"><span class="icon16 icomoon-icon-arrow-right"></span></span><li><a href="location_wise_inventory_list.php?id='.$locid.'">Location Wise Inventory List</a></li><span class="divider"><span class="icon16 icomoon-icon-arrow-right"></span></span><li class="active">Inventory View</li>';
