<?php
	...
	if(isset($_SESSION["usertype"]) && trim($_SESSION["usertype"]) == "employee")
	{
		...
		if(in_array("TeamAttendanceReport",$_SESSION["userrights"]) || in_array("LeaveReport",$_SESSION["userrights"]) || in_array("BreakExceedReport",$_SESSION["userrights"]) || in_array('LateComingReport',$_SESSION["userrights"]) || in_array('BreakExceedApprovedReport',$_SESSION["userrights"]) || in_array('ShiftMovementReport',$_SESSION["userrights"]) || in_array('AllEmployeesAttendanceReport',$_SESSION["userrights"]) || in_array('ReportAttrition',$_SESSION["userrights"]) || in_array('HeadCountReportForReportingHeads',$_SESSION["userrights"]))
