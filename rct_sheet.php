<?php 
	...
	$tpl->load_file('rct_sheet.html','main_container');

	$PageIdentifier = "RctSheet";
	include_once('userrights.php');

	$tpl->set_var("mainheading","RCT Report");
	$breadcrumb = '<li class="active">RCT Report</li>';
	...
	if((isset($_POST['month']) && $_POST['month'] != '') || (isset($_POST['year']) && $_POST['year'] != '') || (isset($_POST['year']) && $_POST['final_hr_status'] != ''))
	{
		$arrCandidateList = $objCandidateList->fnGetAllCandidateByMonth($_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$rct_source = $objCandidateList->fnGetAllRctSourceForRctReportWithStatus($_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$tpl->set_var("curmonth",$_POST['month']);
		$tpl->set_var("curyear",$_POST['year']);
		$tpl->set_var("curStatus",$_POST['final_hr_status']);
		
		$countTotalCandidates = $objCandidateList->fnGetAllCandidatesTotal($_POST['month'],$_POST['year'],$_POST['final_hr_status']);
	}
	else
	{
		$arrCandidateList = $objCandidateList->fnGetAllCandidateListForRCT();
		$rct_source = $objCandidateList->fnGetAllRctSourceForRctReport();
	}
	...
	if(count($arrCandidateList) > 0)
	{
		foreach($arrCandidateList as $candidate)
		{
			...
			$hrstatus = array("1"=>"Y", "2"=>"Y", "3"=>"Y" ,"4"=>"Y" ,"5" => "Y","0"=>"N/A");
	...
	foreach($rct_division as $rctdivision)
	{
		...
		$recordFromRctDivision = $objCandidateList->fnGetAllRctDivisionRecordsCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getShortlistedCandidates = $objCandidateList->fnGetAllShortlistedCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getHiredCandidates = $objCandidateList->fnGetAllHiredCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getRejectedCandidates = $objCandidateList->fnGetAllRejectedCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getDeclinedCandidates = $objCandidateList->fnGetAllDeclinedCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getHoldCandidates = $objCandidateList->fnGetAllHoldCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getTestCandidates = $objCandidateList->fnGetAllTestCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getFRTCandidates = $objCandidateList->fnGetAllFRTCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
		$getFutureProspectsCandidates = $objCandidateList->fnGetAllFutureCandidatesCount($rctdivision['id'],$_POST['month'],$_POST['year'],$_POST['final_hr_status']);
