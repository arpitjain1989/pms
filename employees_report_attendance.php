<?php 
	...
	$tpl->load_file('employees_report_attendance.html','main_container');

	$PageIdentifier = "AllEmployeesAttendanceReport";
	...
	if(isset($_POST["action"]) && trim($_POST["action"]) == "AttendanceSearch")
	{
		...
		header("Location: employees_report_attendance.php");
		exit;
	}
