<?php
	...
	$tpl->load_file('admin_shift_movement.html','main_container');

	$PageIdentifier = "AdminShiftMovement";
	include_once('userrights.php');

	$tpl->set_var("mainheading","Add Shift Movement");
	$breadcrumb = '<li><a href="admin_shift_movement_list.php">Manage Shift Movement</a></li><span class="divider"><span class="icon16 icomoon-icon-arrow-right"></span></span><li class="active">Add Shift Movement</li>';
