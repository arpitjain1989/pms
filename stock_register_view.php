<?php
	...
	$tpl->load_file('stock_register_view.html','main_container');
	...
	/* Set heading */
	$tpl->set_var("mainheading","View Stock Register");
	
	/* Set breadcrumb */
	$breadcrumb = '<li><a href="stock_register_list.php">Manage Stock Register</a></li><span class="divider"><span class="icon16 icomoon-icon-arrow-right"></span></span><li class="active">Stock Register View</li>';
