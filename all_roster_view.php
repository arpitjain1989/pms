<?php
	...
	$tpl->load_file('all_roster_view.html','main_container');

	$PageIdentifier = "ViewAllRoster";
	include_once('userrights.php');

	$tpl->set_var("mainheading","View Roster");
	$breadcrumb = '<li><a href="all_roster_list.php">View All Rosters</a></li><span class="divider"><span class="icon16 icomoon-icon-arrow-right"></span></span><li class="active">View Roster</li>';
