<?php 
	...
	$tpl->load_file('report_pending_document.html','main_container');

	$PageIdentifier = "PendingDocumentReport";
	include_once('userrights.php');

	
	$tpl->set_var("mainheading","Pending Document Report");
	$breadcrumb = '<li class="active">Pending Document Report</li>';
